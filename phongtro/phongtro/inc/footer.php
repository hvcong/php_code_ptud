        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <a href="lienhe.php" class="footer__item-link">Thông tin về chúng tôi</a
                        >
                        <a href="#" class="footer__item-link">Bảo mật</a>
                    <a href="chinhsach.php" class="footer__item-link">Chính sách</a>
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="footer__company">
                        <div class="footer__logo">
                            <img src="images/logo.jpg" alt="" class="footer__logo-img" />
                        </div>
                    </div>
                </div>
            </div>
