            ...
            <div class="container">
                ...
                <div class="contract__body">
                    <div class="row">
                        ...
                        <?php
                            $get_hopdong_by_admin = $pd->show_admin();
                        ...
                        ?>
                         <?php
                            $get_hopdong_by_khachhang = $pd->get_user_by_hopdong($id);
                        ...
                        <?php
                            $get_hopdong_by_id = $pd->get_show_hopdong_khachhang($id);
                        ...
                        <div class="col-12">
                            <div class="contract__image">
                                <div class="contract__image-body">
                                    <img src="../admin/uploads/<?php echo $result_id['image_hopdong']; ?>" alt="" class="contract__image-img" />
                                </div>
                            </div>
                        </div>
                        <?php
